...
public class MeasurementTestData {
    ...
    public static final Measurement measurement4 = new Measurement(M_ID + 3, LocalDate.of(2021, 2, 22), 48.0, 58d, 86d);
    ...
    public static Measurement getNew() {
        return new Measurement(100005, LocalDate.now(), 48.8d, 59d, 86d);
    }
