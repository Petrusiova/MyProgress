...
<div class="row">
    <div class="col-xl-6">
        <div class="card mb-4">
            ...
            <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myAreaChart" width="1021" height="407" style="display: block; height: 326px; width: 817px;" class="chartjs-render-monitor"></canvas></div>
        </div>
    </div>
</div>
</body>
