        ...
        <section>
            ...
            <form method="post" action="measurements">
                ...
                <dl>
                    ...
                    <dd><input class="form-control" type="date" value="${measurement.date}" name="date" required></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.weight"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.weight}" size=40 name="weight" required></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.waist"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.waist}" size=40 name="waist" required></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.hips"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.hips}" size=40 name="hips" required></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.shoulders"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.shoulders}" size=40 name="shoulders"></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.quad"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.quad}" size=40 name="quad"></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.bicep"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.bicep}" size=40 name="bicep"></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.avgCalories"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.avgCalories}" size=40 name="avgCalories"></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.trainingCount"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.trainingCount}" size=40 name="trainingCount"></dd>
                </dl>
                <dl>
                    <dt><spring:message code="measurements.avgSteps"/>:</dt>
                    <dd><input class="form-control" type="text" value="${measurement.avgSteps}" size=40 name="avgSteps"></dd>
                </dl>
